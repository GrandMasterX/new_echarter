...
<input type="hidden" id="formlang" value="ru">
    <?php $this->widget('modules.privatoffice.components.widgets.HeaderPrivatOfficeWidget'); ?>

<div class="container-fluid">
    <div class="row-fluid">
        <?php $this->widget('modules.privatoffice.components.widgets.LeftBlockPrivatOfficeWidget'); ?>
