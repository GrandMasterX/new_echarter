...
$city22="Ираклион";
$country22="Греция";
$inTarget="в Ираклион"; //на Мальту, в Сплит
$ofTarget="Ираклиона";  // аэропорт Сплита
$toCity = 'Ираклион, Греция';
$toCityId = 'DB2BC65F9664925DE040B859605261DA';
$individual='<h1>Чартер в Ираклион </h1>
